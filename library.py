...
class LibraryManagementSystem:
    def __init__(self,root):
        ...
        # ===================================ButtonFrame=====================================
        btnAddData=Button(ButtonFrame,command=self.add_data,text="ADD DATA",font=("arial",12,"bold"),width=23,bg="black",fg="blue")
        btnAddData.grid(row=0,column=0)

        btnShowData=Button(ButtonFrame,command=self.showData,text="SHOW DATA",font=("arial",12,"bold"),width=23,bg="black",fg="blue")
        btnShowData.grid(row=0,column=1)

        btnUpdate=Button(ButtonFrame,command=self.update_data,text="UPDATE",font=("arial",12,"bold"),width=23,bg="black",fg="blue")
        btnUpdate.grid(row=0,column=2)

        btnDelete=Button(ButtonFrame,command=self.mDelete,text="DELETE",font=("arial",12,"bold"),width=23,bg="black",fg="blue")
        btnDelete.grid(row=0,column=3)

        btnReset=Button(ButtonFrame,command=self.reset,text="RESET",font=("arial",12,"bold"),width=23,bg="black",fg="blue")
        btnReset.grid(row=0,column=4)

        btnExit=Button(ButtonFrame,command=self.iExit,text="EXIT",font=("arial",12,"bold"),width=23,bg="black",fg="blue")
    ...
    def add_data(self):
        if self.member_var.get()=="" or self.postcode_var.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="rootroot",database="mydata")
